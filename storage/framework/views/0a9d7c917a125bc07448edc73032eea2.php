...
<?php $__env->startSection('content'); ?>
    ...
    <div class="mb-8 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 rounded-3xl p-8 text-white shadow-2xl hover-lift glow-animation relative overflow-hidden">
        ...
        <div class="relative">
            <div class="flex items-center gap-3 mb-3">
                ...
                <div>
                    <h1 class="text-3xl font-extrabold uppercase tracking-wide">Welcome Back, <?php echo e(Auth::user()->name); ?>!</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="stat-card bg-gradient-to-br from-orange-400 to-orange-500 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <div class="relative">
                ...
                <p class="text-4xl font-bold pulse-animation"><?php echo e($applications); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card bg-gradient-to-br from-amber-400 to-amber-500 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <div class="relative">
                ...
                <p class="text-4xl font-bold pulse-animation"><?php echo e($pending); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card bg-gradient-to-br from-emerald-400 to-emerald-500 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <div class="relative">
                ...
                <p class="text-4xl font-bold pulse-animation"><?php echo e($applications - $pending); ?></p>
            </div>
        </div>
        ...
        <div class="stat-card bg-gradient-to-br from-rose-400 to-rose-500 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
            ...
            <div class="relative">
                ...
                <a href="<?php echo e(route('customer.loans.index')); ?>" class="inline-block mt-2 px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg text-sm font-semibold transition-all duration-300 hover-lift">
                    Apply Now →
                </a>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <a href="<?php echo e(route('customer.loans.index')); ?>" class="bg-white rounded-2xl p-6 shadow-lg hover-lift border border-orange-100 transition-all duration-300">
        ...
        <a href="<?php echo e(route('customer.profile')); ?>" class="bg-white rounded-2xl p-6 shadow-lg hover-lift border border-orange-100 transition-all duration-300">
            <div class="flex items-center gap-4">
        ...
        <a href="<?php echo e(route('customer.home')); ?>" class="bg-white rounded-2xl p-6 shadow-lg hover-lift border border-orange-100 transition-all duration-300">
            <div class="flex items-center gap-4">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="<?php echo e(route('customer.loan-products')); ?>" class="px-4 py-2 bg-orange-100 text-orange-700 rounded-lg font-semibold hover:bg-orange-200 transition-all duration-300">
                View All →
            </a>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-orange-100 overflow-hidden hover-lift">
                ...
                <div class="bg-gradient-to-r from-orange-400 to-orange-500 p-4 text-white">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="font-bold text-sm"><?php echo e($product->provider_company); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-sm text-gray-600 mt-2 line-clamp-2"><?php echo e($product->description); ?></p>
                    </div>
                    ...
                    <div class="mb-4 p-3 bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl border border-orange-200">
                        ...
                        <p class="text-lg font-bold text-orange-600">
                            UGX <?php echo e(number_format($product->min_amount, 0)); ?> - <?php echo e(number_format($product->max_amount, 0)); ?>
                    ...
                    <div class="space-y-2 mb-4">
                        <div class="flex justify-between items-center text-sm">
                            ...
                            <span class="font-bold text-orange-600"><?php echo e(number_format($product->interest_rate, 2)); ?>%</span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-gray-600">Term</span>
                            <span class="font-semibold text-gray-900"><?php echo e($product->min_term); ?>-<?php echo e($product->max_term); ?> months</span>
                        </div>
                        <div class="flex justify-between items-center text-sm">
                            <span class="text-gray-600">Processing Fee</span>
                            <span class="font-semibold text-gray-900"><?php echo e(number_format($product->processing_fee_percent, 2)); ?>%</span>
                        </div>
                    </div>

                    <!-- Action Button -->
                    <a href="<?php echo e(route('customer.loans.apply')); ?>?product_id=<?php echo e($product->id); ?>" class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-orange-400 to-orange-500 rounded-xl font-semibold text-sm text-white uppercase tracking-widest hover:from-orange-500 hover:to-orange-600 transition-all duration-300 shadow-lg hover:shadow-xl">
...
<?php echo $__env->make('customer.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\UPTREND LMS\resources\views/customer/home.blade.php ENDPATH**/ ?>