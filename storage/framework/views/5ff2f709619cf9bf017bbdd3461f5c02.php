    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-7">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                <a href="<?php echo e(route('applications.index')); ?>" class="widget-card block bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden border-gradient">
                ...
                <a href="<?php echo e(route('loans.index')); ?>" class="widget-card block bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden border-gradient">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 float-animation"></div>
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                ...
                <a href="<?php echo e(route('borrowers.index')); ?>" class="widget-card block bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden border-gradient">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 float-animation"></div>
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                ...
                <a href="<?php echo e(route('repayments.index')); ?>" class="widget-card block bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden border-gradient">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -mr-16 -mt-16 float-animation"></div>
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
            ...
            <div class="widget-card bg-white rounded-2xl border border-orange-100 shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <a href="<?php echo e(route('applications.index')); ?>" class="group p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 hover-lift">
                    ...
                    <a href="<?php echo e(route('loans.index')); ?>" class="group p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 hover-lift">
                        <div class="text-2xl mb-2 icon-bounce">💰</div>
                    ...
                    <a href="<?php echo e(route('loan-products.index')); ?>" class="group p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 hover-lift">
                        <div class="text-2xl mb-2 icon-bounce">💼</div>
                    ...
                    <a href="<?php echo e(route('borrowers.index')); ?>" class="group p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 hover-lift">
                        <div class="text-2xl mb-2 icon-bounce">👥</div>
                    ...
                    <a href="<?php echo e(route('repayments.index')); ?>" class="group p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 hover-lift">
                        <div class="text-2xl mb-2 icon-bounce">💳</div>
                    ...
                    <a href="<?php echo e(route('disbursements.index')); ?>" class="group p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 hover-lift">
                        <div class="text-2xl mb-2 icon-bounce">💸</div>
                    ...
                    <a href="<?php echo e(route('credit-scores.index')); ?>" class="group p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 hover-lift">
                        <div class="text-2xl mb-2 icon-bounce">⭐</div>
                    ...
                    <a href="<?php echo e(route('reports.index')); ?>" class="group p-4 rounded-xl border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 hover-lift">
                        <div class="text-2xl mb-2 icon-bounce">📈</div>
