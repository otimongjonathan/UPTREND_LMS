<footer class="shrink-0 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white">
            ...
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="flex flex-col sm:flex-row items-center gap-4 text-sm text-gray-400">
                    ...
                    <div class="flex gap-4">
                        <a href="<?php echo e(route('privacy-policy')); ?>" data-footer-title="Privacy Policy"
...
<?php /**PATH D:\xampp\htdocs\UPTREND LMS\resources\views/layouts/footer.blade.php ENDPATH**/ ?>