...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('applications.index')); ?>" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">
                ...
                <div class="px-8 py-8 text-white">
                    <div class="flex justify-between items-center mb-4">
                        <div>
                            ...
                            <p class="text-blue-100 text-lg"><?php echo e($application->applicant_full_name); ?></p>
                        </div>
                        <div class="text-right">
                            <span class="px-6 py-3 rounded-full text-lg font-bold shadow-lg
                                <?php if($application->status === 'pending'): ?> bg-yellow-400 text-yellow-900
                                <?php elseif($application->status === 'approved'): ?> bg-blue-400 text-blue-900
                                <?php elseif($application->status === 'issued'): ?> bg-green-400 text-green-900
                                <?php elseif($application->status === 'rejected'): ?> bg-red-400 text-red-900
                                <?php endif; ?>">
                                <?php echo e(str($application->status)->title()); ?>

                            </span>
                            <p class="text-blue-100 mt-2"><?php echo e($application->application_date?->format('M d, Y \a\t h:i A')); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                        <div class="bg-white/10 backdrop-blur rounded-xl p-4">
                            ...
                            <div class="text-2xl font-bold">UGX <?php echo e(number_format($application->amount, 0)); ?></div>
                        </div>
                        <div class="bg-white/10 backdrop-blur rounded-xl p-4">
                            <div class="text-blue-100 text-sm font-medium">Term</div>
                            <div class="text-2xl font-bold"><?php echo e($application->confirmed_term_months ?? $application->term_months ?? 'N/A'); ?> months</div>
                        </div>
                        <div class="bg-white/10 backdrop-blur rounded-xl p-4">
                            <div class="text-blue-100 text-sm font-medium">Frequency</div>
                            <div class="text-2xl font-bold"><?php echo e(str($application->confirmed_payment_frequency ?? $application->repayment_schedule)->title()->replace('_', ' ')); ?></div>
                        </div>
                        <div class="bg-white/10 backdrop-blur rounded-xl p-4">
                            <div class="text-blue-100 text-sm font-medium">Monthly Income</div>
                            <div class="text-2xl font-bold">UGX <?php echo e(number_format($application->monthly_income, 0)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                        ...
                        <div class="px-8 py-8">
                            <?php if($application->loan_product_id): ?>
                                <div class="bg-green-50 border border-green-200 rounded-xl p-6 mb-6">
                                    <p class="text-sm text-green-600 font-semibold mb-2">✓ Loan Product Assigned</p>
                                    <p class="text-lg font-bold text-green-900"><?php echo e($application->product?->name ?? 'Unknown Product'); ?></p>
                                    <p class="text-sm text-green-700 mt-2">Interest Rate: <?php echo e($application->product?->interest_rate ?? 'N/A'); ?>%</p>
                                </div>
                            <?php else: ?>
                            ...
                            <form action="<?php echo e(route('applications.assign-product', $application->id)); ?>" method="POST" class="space-y-4">
                                <?php echo csrf_field(); ?>
                                <div class="space-y-2">
                                    ...
                                    <select name="loan_product_id" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-cyan-500/20 focus:border-cyan-500 transition-all duration-200" required>
                                        ...
                                        <?php $__empty_1 = true; $__currentLoopData = $loanProducts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <option value="<?php echo e($product->id); ?>" <?php echo e($application->loan_product_id == $product->id ? 'selected' : ''); ?>>
                                                <?php echo e($product->name); ?> (<?php echo e($product->interest_rate); ?>% - UGX <?php echo e(number_format($product->min_amount, 0)); ?> to <?php echo e(number_format($product->max_amount, 0)); ?>)
                                            </option>
                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                        <div class="bg-gradient-to-r from-orange-500 to-red-500 px-8 py-6">
                            ...
                            <?php if($application->hasConfirmedTerms()): ?>
                                <p class="text-orange-100 mt-2">
                                    Last modified: <?php echo e($application->terms_last_modified?->format('M d, Y \a\t h:i A')); ?>
                        ...
                        <div class="px-8 py-8">
                            <?php if($application->hasConfirmedTerms()): ?>
                                <?php $terms = $application->getEffectiveTerms(); ?>
                                    ...
                                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xl font-bold text-blue-900"><?php echo e(str($terms['payment_frequency'])->title()->replace('_', ' ')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-gradient-to-br from-green-50 to-green-100 p-6 rounded-xl border border-green-200">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xl font-bold text-green-900"><?php echo e($terms['term_months']); ?> Months</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xl font-bold text-purple-900"><?php echo e($terms['installment_count']); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xl font-bold text-orange-900">UGX <?php echo e(number_format($terms['installment_amount'], 0)); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 p-6 rounded-xl border border-indigo-200">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xl font-bold text-indigo-900"><?php echo e($terms['first_due_date']?->format('M d, Y')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-xl border border-red-200">
                                        <div class="flex items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-xl font-bold text-red-900"><?php echo e($terms['final_due_date']?->format('M d, Y')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="border-t border-gray-200 pt-8 mt-8">
                                <h4 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
                                    ...
                                    <?php echo e($application->hasConfirmedTerms() ? 'Modify Terms' : 'Set Confirmed Terms'); ?>

                                </h4>
                                <form action="<?php echo e(route('applications.update-terms', $application->id)); ?>" method="POST" class="space-y-6">
                                    <?php echo csrf_field(); ?>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="space-y-2">
                                            ...
                                            <select name="payment_frequency" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-200" required>
                                                <option value="weekly" <?php echo e(($application->confirmed_payment_frequency ?? $application->repayment_schedule) === 'weekly' ? 'selected' : ''); ?>>Weekly</option>
                                                <option value="bi_weekly" <?php echo e(($application->confirmed_payment_frequency ?? $application->repayment_schedule) === 'bi_weekly' ? 'selected' : ''); ?>>Bi-Weekly</option>
                                                <option value="monthly" <?php echo e(($application->confirmed_payment_frequency ?? $application->repayment_schedule) === 'monthly' ? 'selected' : ''); ?>>Monthly</option>
                                                <option value="quarterly" <?php echo e(($application->confirmed_payment_frequency ?? $application->repayment_schedule) === 'quarterly' ? 'selected' : ''); ?>>Quarterly</option>
                                            </select>
                                        </div>
                                        <div class="space-y-2">
                                            <label class="block text-sm font-bold text-gray-700">First Due Date</label>
                                            <input type="date" name="first_due_date" 
                                                   value="<?php echo e($application->confirmed_first_due_date?->format('Y-m-d') ?? now()->addMonth()->format('Y-m-d')); ?>"
                                                   min="<?php echo e(now()->addMonth()->format('Y-m-d')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="flex gap-4">
                                        <button type="submit" class="px-8 py-3 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-xl font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                            <?php echo e($application->hasConfirmedTerms() ? 'Update Terms' : 'Confirm Terms'); ?>
                    ...
                    <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100">
                        <div class="bg-gradient-to-r from-green-500 to-teal-500 px-8 py-6">
                            ...
                            <?php if($application->hasCalculatedFees()): ?>
                                <p class="text-green-100 mt-2">
                                    Calculated: <?php echo e($application->fees_calculated_at?->format('M d, Y \a\t h:i A')); ?>

                                </p>
                            <?php endif; ?>
                        </div>
                        <div class="px-8 py-8" data-loan-amount="<?php echo e($application->amount); ?>">
                            <?php if($application->hasCalculatedFees()): ?>
                                <?php $feeBreakdown = $application->getFeeBreakdown(); ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="text-xs bg-blue-200 text-blue-800 px-2 py-1 rounded-full font-semibold"><?php echo e($feeBreakdown['fees']['processing']['percent']); ?>%</span>
                                        </div>
                                        <p class="text-sm text-blue-600 font-semibold mb-1">Processing Fee</p>
                                        <p class="text-2xl font-bold text-blue-900">UGX <?php echo e(number_format($feeBreakdown['fees']['processing']['amount'], 0)); ?></p>
                                    </div>
                                    ...
                                    <div class="bg-gradient-to-br from-purple-50 to-purple-100 p-6 rounded-xl border border-purple-200">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="text-xs bg-purple-200 text-purple-800 px-2 py-1 rounded-full font-semibold"><?php echo e($feeBreakdown['fees']['insurance']['percent']); ?>%</span>
                                        </div>
                                        <p class="text-sm text-purple-600 font-semibold mb-1">Insurance Fee</p>
                                        <p class="text-2xl font-bold text-purple-900">UGX <?php echo e(number_format($feeBreakdown['fees']['insurance']['amount'], 0)); ?></p>
                                    </div>
                                    ...
                                    <div class="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-xl border border-orange-200">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="text-xs bg-orange-200 text-orange-800 px-2 py-1 rounded-full font-semibold"><?php echo e($feeBreakdown['taxes']['vat']['percent']); ?>%</span>
                                        </div>
                                        <p class="text-sm text-orange-600 font-semibold mb-1">VAT</p>
                                        <p class="text-2xl font-bold text-orange-900">UGX <?php echo e(number_format($feeBreakdown['taxes']['vat']['amount'], 0)); ?></p>
                                    </div>
                                    ...
                                    <div class="bg-gradient-to-br from-red-50 to-red-100 p-6 rounded-xl border border-red-200">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="text-xs bg-red-200 text-red-800 px-2 py-1 rounded-full font-semibold"><?php echo e($feeBreakdown['taxes']['withholding']['percent']); ?>%</span>
                                        </div>
                                        <p class="text-sm text-red-600 font-semibold mb-1">Withholding Tax</p>
                                        <p class="text-2xl font-bold text-red-900">UGX <?php echo e(number_format($feeBreakdown['taxes']['withholding']['amount'], 0)); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-8 rounded-2xl border-2 border-gray-200">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                        <div class="text-center">
                                            ...
                                            <p class="text-3xl font-bold text-gray-900">UGX <?php echo e(number_format($feeBreakdown['summary']['gross_loan_amount'], 0)); ?></p>
                                        </div>
                                        <div class="text-center">
                                            <p class="text-sm text-red-600 font-semibold mb-2">Total Deductions</p>
                                            <p class="text-3xl font-bold text-red-700">-UGX <?php echo e(number_format($feeBreakdown['summary']['total_deductions'], 0)); ?></p>
                                        </div>
                                        <div class="text-center">
                                            <p class="text-sm text-green-600 font-semibold mb-2">Net Disbursement</p>
                                            <p class="text-3xl font-bold text-green-700">UGX <?php echo e(number_format($feeBreakdown['summary']['net_disbursement'], 0)); ?></p>
                                        </div>
                                        <div class="text-center">
                                            <p class="text-sm text-blue-600 font-semibold mb-2">Total Repayment</p>
                                            <p class="text-3xl font-bold text-blue-700">UGX <?php echo e(number_format($feeBreakdown['summary']['total_repayment'], 0)); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($application->status === 'pending' || $application->status === 'approved'): ?>
                            <div class="<?php echo e($application->hasCalculatedFees() ? 'border-t border-gray-200 pt-8 mt-8' : ''); ?>">
                                <h4 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
                                    <svg class="w-5 h-5 mr-2 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                    </svg>
                                    <?php echo e($application->hasCalculatedFees() ? 'Recalculate Fees' : 'Calculate Fees & Taxes'); ?>

                                </h4>
                                <form action="<?php echo e(route('applications.calculate-fees', $application->id)); ?>" method="POST" class="space-y-6">
                                    <?php echo csrf_field(); ?>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div class="space-y-2">
                                            ...
                                            <input type="number" name="processing_fee_percent" step="0.01" min="0" max="10"
                                                   value="<?php echo e($application->processing_fee_percent ?? ($application->product?->processing_fee_percent ?? 2.5)); ?>"
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">From loan product: <?php echo e($application->product?->processing_fee_percent ?? 'N/A'); ?>%</p>
                                        </div>
                                        <div class="space-y-2">
                                            ...
                                            <input type="number" name="insurance_fee_percent" step="0.01" min="0" max="5"
                                                   value="<?php echo e($application->insurance_fee_percent ?? ($application->product?->insurance_premium_percent ?? 1.0)); ?>"
                                                   class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200" required>
                                            <p class="text-xs text-gray-500 mt-1">From loan product: <?php echo e($application->product?->insurance_premium_percent ?? 'N/A'); ?>%</p>
                                        </div>
                                        <div class="space-y-2">
                                            <label class="block text-sm font-bold text-gray-700">VAT (%)</label>
                                            <input type="number" name="vat_percent" step="0.01" min="0" max="25"
                                                   value="<?php echo e($application->vat_percent ?? 18.0); ?>"
                                                   class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200" required>
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <input type="number" name="withholding_tax_percent" step="0.01" min="0" max="10"
                                                   value="<?php echo e($application->withholding_tax_percent ?? 0.0); ?>"
                                                   class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-green-500/20 focus:border-green-500 transition-all duration-200" required>
                                    ...
                                    <div class="flex gap-4">
                                        <button type="submit" class="px-8 py-3 bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white rounded-xl font-bold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                                            <?php echo e($application->hasCalculatedFees() ? 'Recalculate Fees' : 'Calculate Fees'); ?>
                        ...
                        <div class="px-6 py-6">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-900 font-medium"><?php echo e($application->applicant_full_name); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Date of Birth</p>
                                    <p class="text-gray-900 font-medium"><?php echo e($application->dob?->format('M d, Y')); ?></p>
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Gender</p>
                                        <p class="text-gray-900 font-medium"><?php echo e(str($application->gender)->title()); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Marital Status</p>
                                        <p class="text-gray-900 font-medium"><?php echo e(str($application->marital_status)->title()); ?></p>
                                    </div>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Employment</p>
                                    <p class="text-gray-900 font-medium"><?php echo e(str($application->employment_status)->title()->replace('_', ' ')); ?></p>
                                    <p class="text-sm text-gray-600"><?php echo e($application->occupation); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-6 py-6">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-900 font-medium"><?php echo e($application->district_city); ?></p>
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">County</p>
                                        <p class="text-gray-900 font-medium"><?php echo e($application->county); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Sub-County</p>
                                        <p class="text-gray-900 font-medium"><?php echo e($application->sub_county); ?></p>
                                    </div>
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Parish</p>
                                        <p class="text-gray-900 font-medium"><?php echo e($application->parish); ?></p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Village</p>
                                        <p class="text-gray-900 font-medium"><?php echo e($application->village); ?></p>
                                    </div>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Residence Status</p>
                                    <p class="text-gray-900 font-medium"><?php echo e(str($application->residence_status)->title()); ?></p>
                                </div>
                                <?php if($application->po_box): ?>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">P.O. Box</p>
                                    <p class="text-gray-900 font-medium"><?php echo e($application->po_box); ?></p>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="px-6 py-6">
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <p class="text-gray-900 font-medium"><?php echo e(str($application->loan_type)->title()->replace('_', ' ')); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Purpose</p>
                                    <p class="text-gray-900 font-medium"><?php echo e($application->purpose); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Original Schedule</p>
                                    <p class="text-gray-900 font-medium"><?php echo e(str($application->repayment_schedule)->title()->replace('_', ' ')); ?></p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-500 font-semibold uppercase tracking-wide">Original Term</p>
                                    <p class="text-gray-900 font-medium"><?php echo e($application->term_months ?? 'N/A'); ?> months</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="px-6 py-6">
                            <div class="space-y-3">
                                ...
                                <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($application->$field): ?>
                                        <a href="<?php echo e(route('loans.download', [$application->id, $field])); ?>" class="flex items-center px-4 py-3 bg-green-50 hover:bg-green-100 rounded-lg border border-green-200 transition group">
                                            <svg class="w-5 h-5 text-green-600 mr-3 group-hover:text-green-700" fill="currentColor" viewBox="0 0 20 20">
                                                <path d="M4 3a2 2 0 100 4h12a2 2 0 100-4H4z"/>
                                                <path d="M3 8a2 2 0 012-2v9a2 2 0 01-2-2V8zM17 6a2 2 0 012 2v7a2 2 0 01-2 2V6z"/>
                                            </svg>
                                            <span class="text-green-900 font-medium text-sm"><?php echo e($label); ?></span>
                                    ...
                                    <?php else: ?>
                                        <div class="flex items-center px-4 py-3 bg-gray-50 rounded-lg border border-gray-200 opacity-60">
                                            ...
                                            <span class="text-gray-500 font-medium text-sm"><?php echo e($label); ?></span>
            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-100 mt-8">
                ...
                <div class="px-8 py-8 bg-gray-50">
                    ...
                    <?php else: ?>
                        ...
                        <form action="<?php echo e(route('loans.issue', $application->id)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
                ...
                <div class="px-8 py-6 bg-gray-50">
                    <p class="text-gray-700 text-lg flex items-center">
                        ...
                        <span class="px-4 py-2 rounded-full text-lg font-bold ml-4
                            <?php if($application->status === 'issued'): ?> bg-green-100 text-green-700
...
<script src="<?php echo e(asset('js/enhanced-fee-calculator.js')); ?>"></script>
<?php /**PATH D:\xampp\htdocs\UPTREND LMS\resources\views/applications/show.blade.php ENDPATH**/ ?>