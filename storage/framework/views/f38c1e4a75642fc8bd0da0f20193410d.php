                ...
                <div class="product-card bg-white rounded-2xl shadow-lg border border-orange-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-4 pb-4 border-b border-orange-100">
                            ...
                            <p class="text-sm text-gray-600 mt-2"><?php echo e($product->description); ?></p>
                        </div>
                        ...
                        <div class="space-y-3 mb-6">
                            ...
                            <div class="flex justify-between items-center text-sm p-2 rounded-lg hover:bg-orange-50 transition">
                                ...
                                <span class="font-semibold text-orange-600"><?php echo e(number_format($product->interest_rate, 2)); ?>%</span>
                            </div>
                            <div class="flex justify-between items-center text-sm p-2 rounded-lg hover:bg-orange-50 transition">
                                <span class="text-gray-600 flex items-center gap-2">
                            ...
                            <div class="flex justify-between items-center text-sm p-2 rounded-lg hover:bg-orange-50 transition">
                                ...
                                <span class="font-semibold text-gray-900"><?php echo e(number_format($product->insurance_premium_percent, 2)); ?>%</span>
                            </div>
                            <div class="flex justify-between items-center text-sm p-2 rounded-lg hover:bg-orange-50 transition">
                                <span class="text-gray-600 flex items-center gap-2">
                                    <span>⏰</span> Late Fee
                                </span>
                                <span class="font-semibold text-red-600"><?php echo e(number_format($product->late_payment_fee_percent, 2)); ?>%</span>
                            </div>
                        </div>
                        ...
                        <div class="mb-6 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                            ...
                            <div class="space-y-2 text-sm">
                                <?php if($product->provider->email): ?>
                                <div class="flex items-center gap-2 text-gray-700">
                                    <svg class="h-4 w-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                    </svg>
                                    <span class="font-medium"><?php echo e($product->provider->email); ?></span>
                                </div>
                                <?php endif; ?>
                                <?php if($product->provider->tel_no): ?>
                                <div class="flex items-center gap-2 text-gray-700">
                                    <svg class="h-4 w-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                    </svg>
                                    <span class="font-medium"><?php echo e($product->provider->tel_no); ?></span>
                                </div>
                                <?php endif; ?>
                                <?php if($product->provider->address): ?>
                                <div class="flex items-start gap-2 text-gray-700">
                                    ...
                                    <span class="font-medium"><?php echo e($product->provider->address); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<?php echo $__env->make('customer.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\UPTREND LMS\resources\views/customer/loan-products.blade.php ENDPATH**/ ?>