        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl border border-gray-100">
                ...
                <div class="px-6 py-6">
                    ...
                    <form action="<?php echo e(route('repayments.store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
                            ...
                            <select name="loan_application_id" id="loan_select" required class="w-full rounded-lg border border-gray-300 focus:border-orange-500 focus:ring-orange-500">
                                ...
                                <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($loan->id); ?>" 
                                            data-amount="<?php echo e($loan->amount); ?>"
                                            data-rate="<?php echo e($loan->applied_interest_rate ?? 15); ?>"
                                            data-term="<?php echo e($loan->repayment_term ?? 12); ?>"
                                            <?php if(old('loan_application_id') == $loan->id): echo 'selected'; endif; ?>>
                                        <?php echo e($loan->applicant_full_name ?? $loan->user?->name); ?> - Loan #<?php echo e($loan->id); ?> 
                                        (UGX <?php echo e(number_format($loan->amount, 0)); ?> @ <?php echo e($loan->applied_interest_rate ?? 15); ?>%)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['loan_application_id'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="installment_number" value="<?php echo e(old('installment_number', 1)); ?>" min="1" required 
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="principal_amount" value="<?php echo e(old('principal_amount')); ?>" step="0.01" min="0" required 
                                           class="mt-1 w-full rounded-lg border border-gray-300 focus:border-orange-500 focus:ring-orange-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="interest_amount" value="<?php echo e(old('interest_amount')); ?>" step="0.01" min="0" required 
                                           class="mt-1 w-full rounded-lg border border-gray-300 focus:border-orange-500 focus:ring-orange-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="amount" id="total_amount" value="<?php echo e(old('amount')); ?>" step="0.01" min="0.01" required readonly
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="remaining_balance" id="remaining_balance" value="<?php echo e(old('remaining_balance', '')); ?>" step="0.01" min="0" readonly
                                       class="mt-1 w-full rounded-lg border border-gray-300 bg-gray-100 focus:border-orange-500 focus:ring-orange-500"
                                       placeholder="Will be calculated automatically">
                                <p class="text-xs text-gray-500 mt-1">Outstanding loan balance after this payment</p>
                                <?php $__errorArgs = ['remaining_balance'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-sm text-red-600 mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="payment_frequency" class="mt-1 w-full rounded-lg border border-gray-300 focus:border-orange-500 focus:ring-orange-500">
                                    ...
                                    <option value="weekly" <?php if(old('payment_frequency') === 'weekly'): echo 'selected'; endif; ?>>Weekly</option>
                                    <option value="bi_weekly" <?php if(old('payment_frequency') === 'bi_weekly'): echo 'selected'; endif; ?>>Bi-Weekly</option>
                                    <option value="monthly" <?php if(old('payment_frequency') === 'monthly'): echo 'selected'; endif; ?>>Monthly</option>
                                    <option value="quarterly" <?php if(old('payment_frequency') === 'quarterly'): echo 'selected'; endif; ?>>Quarterly</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="status" required class="mt-1 w-full rounded-lg border border-gray-300 focus:border-orange-500 focus:ring-orange-500">
                                    ...
                                    <option value="partial" <?php if(old('status') === 'partial'): echo 'selected'; endif; ?>>Partial</option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="payment_method" class="mt-1 w-full rounded-lg border border-gray-300 focus:border-orange-500 focus:ring-orange-500">
                                    ...
                                    <option value="mobile_money" <?php if(old('payment_method') === 'mobile_money'): echo 'selected'; endif; ?>>Mobile Money</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="3" class="mt-1 w-full rounded-lg border border-gray-300 focus:border-orange-500 focus:ring-orange-500" 
                                      placeholder="Add any additional notes about this repayment installment..."><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex gap-3 pt-6 border-t">
                            ...
                            <a href="<?php echo e(route('repayments.index')); ?>" class="px-6 py-3 bg-gray-500 text-white rounded-lg font-semibold hover:bg-gray-600 transition">
                                ✗ Cancel
                            </a>
                        </div>
                    </form>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\UPTREND LMS\resources\views/repayments/create.blade.php ENDPATH**/ ?>