...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 scroll-animate">
        ...
        <div class="space-y-3">
            <a href="<?php echo e(route('customer.profile')); ?>" class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
            ...
            <a href="<?php echo e(route('customer.notifications')); ?>" class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                <div class="flex items-center gap-3">
                    <svg class="h-5 w-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('customer.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\UPTREND LMS\resources\views/customer/settings.blade.php ENDPATH**/ ?>