...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <?php if($notifications->where('read_at', null)->count() > 0): ?>
            <form action="<?php echo e(route('customer.notifications.mark-all-read')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <div class="space-y-4">
        <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden <?php echo e($notification->read_at ? 'opacity-75' : 'border-l-4 border-primary-500'); ?>">
                <div class="p-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            ?>
                            <div class="<?php echo e($iconBg); ?> <?php echo e($iconColor); ?> h-12 w-12 rounded-full flex items-center justify-center">
                                <?php if(str_contains($notification->type, 'Approved')): ?>
                                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                <?php elseif(str_contains($notification->type, 'Rejected')): ?>
                                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                <?php elseif(str_contains($notification->type, 'Disbursed')): ?>
                                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                <?php elseif(str_contains($notification->type, 'Repayment')): ?>
                                    <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-4">
                                ...
                                <?php if(!$notification->read_at): ?>
                                    <form action="<?php echo e(route('customer.notifications.mark-read', $notification->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('customer.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\UPTREND LMS\resources\views/customer/notifications.blade.php ENDPATH**/ ?>