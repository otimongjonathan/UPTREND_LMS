...
<div x-data="{ sidebarOpen: true }" class="flex">
    ...
    <nav :class="{ 'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen }" class="fixed md:static md:translate-x-0 left-0 top-0 h-screen w-64 bg-gradient-to-b from-primary-50 to-white border-r border-gray-200 shadow-lg transition-transform duration-300 ease-in-out z-50 md:z-auto flex flex-col overflow-y-auto">
        ...
        <div class="px-4 py-6 space-y-1 flex-1">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" @click="sidebarOpen = false" class="sidebar-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('applications.index')); ?>" @click="sidebarOpen = false" class="sidebar-link <?php echo e(request()->routeIs('applications.*') ? 'active' : ''); ?>">
                <span class="link-icon text-xl me-3">📋</span>
                <span class="link-text">APPLICATIONS</span>
            </a>
            <a href="<?php echo e(route('loans.index')); ?>" @click="sidebarOpen = false" class="sidebar-link <?php echo e(request()->routeIs('loans.*') ? 'active' : ''); ?>">
                <span class="link-icon text-xl me-3">💰</span>
                <span class="link-text">LOANS</span>
            </a>
            <a href="<?php echo e(route('loan-products.index')); ?>" @click="sidebarOpen = false" class="sidebar-link <?php echo e(request()->routeIs('loan-products.*') ? 'active' : ''); ?>">
                <span class="link-icon text-xl me-3">💼</span>
                <span class="link-text">PRODUCTS</span>
            </a>
            <a href="<?php echo e(route('repayments.index')); ?>" @click="sidebarOpen = false" class="sidebar-link <?php echo e(request()->routeIs('repayments.*') ? 'active' : ''); ?>">
                <span class="link-icon text-xl me-3">💳</span>
            ...
            <a href="<?php echo e(route('borrowers.index')); ?>" @click="sidebarOpen = false" class="sidebar-link <?php echo e(request()->routeIs('borrowers.*') ? 'active' : ''); ?>">
                <span class="link-icon text-xl me-3">👥</span>
                <span class="link-text">BORROWERS</span>
            </a>
            <a href="<?php echo e(route('staff.index')); ?>" @click="sidebarOpen = false" class="sidebar-link <?php echo e(request()->routeIs('staff.*') ? 'active' : ''); ?>">
                <span class="link-icon text-xl me-3">👔</span>
        ...
        <div class="user-section bg-gradient-to-t from-white to-transparent border-t border-gray-200 mt-auto">
            <div class="p-4">
                <div class="mb-4 p-3 bg-gradient-to-r from-primary-50 to-orange-50 rounded-lg border border-primary-100 transition-all duration-300 hover:shadow-md">
                    <div class="font-semibold text-sm text-gray-800 truncate"><?php echo e(Auth::guard('staff')->user()->business_name); ?></div>
                    <div class="font-normal text-xs text-gray-500 truncate mt-1"><?php echo e(Auth::guard('staff')->user()->email); ?></div>
                </div>

                <div class="space-y-1">
                    <a href="<?php echo e(route('profile.show')); ?>" @click="sidebarOpen = false" class="sidebar-link text-sm py-2">
                        <span class="link-icon text-lg me-2">👁️</span>
                        <span class="link-text">VIEW PROFILE</span>
                    </a>
                    <a href="<?php echo e(route('profile.edit')); ?>" @click="sidebarOpen = false" class="sidebar-link text-sm py-2">
                        <span class="link-icon text-lg me-2">✏️</span>
...
<?php /**PATH D:\xampp\htdocs\UPTREND LMS\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>