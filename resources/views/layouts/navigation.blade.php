<nav x-data="{ open: false }" class="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-sm">
    <style>
        .nav-link {
            position: relative;
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="menu-trigger inline-flex items-center px-4 py-2 border border-transparent text-sm leading-4 font-semibold rounded-lg text-primary-700 bg-primary-50 hover:bg-primary-100 focus:outline-none transition ease-in-out duration-200">
