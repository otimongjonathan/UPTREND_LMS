                    ...
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="mt-3 text-4xl font-bold stat-badge">{{ $stats['total_applications'] }}</p>
                                <p class="mt-2 text-sm font-medium text-amber-100">{{ $stats['pending_applications'] }} pending</p>
                            </div>
                    ...
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="mt-3 text-4xl font-bold stat-badge">{{ $stats['active_loans'] }}</p>
                                <p class="mt-2 text-sm font-medium text-orange-100">UGX {{ number_format($stats['total_loan_amount'], 2) }}</p>
                            </div>
                            <div class="h-14 w-14 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center icon-bounce">
                                <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="mt-3 text-4xl font-bold stat-badge">{{ $stats['total_borrowers'] }}</p>
                    ...
                    <div class="relative">
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="mt-3 text-4xl font-bold stat-badge">UGX {{ number_format($stats['total_repaid'], 2) }}</p>
                                <p class="mt-2 text-sm font-medium text-emerald-100">{{ $stats['overdue_repayments'] }} overdue</p>
                            </div>
                            <div class="h-14 w-14 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center icon-bounce">
                                <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="lg:col-span-2 workspace-card widget-card rounded-2xl overflow-hidden shadow-xl bg-gradient-to-br from-orange-400 to-red-400 text-white p-8 relative">
                    ...
                    <div class="relative">
                        ...
                        <div class="mt-8 flex flex-wrap gap-3">
                            <a href="{{ route('loans.index') }}" class="inline-flex items-center gap-2 rounded-xl bg-white/20 hover:bg-white/30 backdrop-blur-sm px-5 py-3 text-sm font-semibold transition shadow-lg">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                                View Loans
                            </a>
                            <a href="{{ route('applications.index') }}" class="inline-flex items-center gap-2 rounded-xl bg-white/20 hover:bg-white/30 backdrop-blur-sm px-5 py-3 text-sm font-semibold transition shadow-lg">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                                Manage Applications
                            </a>
                            <a href="{{ route('repayments.index') }}" class="inline-flex items-center gap-2 rounded-xl bg-white/20 hover:bg-white/30 backdrop-blur-sm px-5 py-3 text-sm font-semibold transition shadow-lg">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                                Track Repayments
