        ...
        <div class="max-width mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('collaterals.update', [$loan, $collateral]) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" id="collateral_type" name="collateral_type" value="{{ old('collateral_type', $collateral->collateral_type) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
